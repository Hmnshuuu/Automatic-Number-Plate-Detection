...
st.title("Number Plate Detection Model") 
uploaded_file = st.file_uploader("Upload an image or video", type=["jpg", "jpeg", "png", "bmp", "mp4", "avi", "mov", "mkv"])


# model = YOLO('C:\Users\himan\Downloads\License_plate\License_plate\best.pt')
model = YOLO(r'C:\Users\himan\Downloads\License_plate\License_plate\best.pt')
